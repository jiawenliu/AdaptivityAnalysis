...
\begin{enumerate}
  ...
  \highlight{Its weight will be estimated in next step in Section~\ref{sec:alg_weightgen}.} 
  ...
  \highlight{Its weight will be estimated in next step in Section~\ref{sec:alg_weightgen} as well.}
  \\
