...
\begin{defn}[Variable May Dependency].
 ...
 \right)
  ...
  \]
  %
  , where $\eventdep^{val}$ and $\eventdep^{val}$ is defined in \ref{def:event_valdep} and \ref{def:event_ctldep}.
  %
  %
  \end{defn}
  %
  explanation: Among all events corresponding to the evaluations of the assignment commands associated to the two labeled variables respectively, 
