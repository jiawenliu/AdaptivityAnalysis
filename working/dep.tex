...
\bigwedge & (\event_1, \vcounter(\vtrace_1 \cdot \event_1) l_1) \sigeq 
(\event_1', \vcounter(\vtrace_1 \cdot \event_1')l_1)\\
\bigwedge & 
\sigdiff((\event_2, \vcounter(\vtrace_1 \cdot \event_1 \cdot \vtrace_2\cdot \event_2) l_2),
(\event_2', \vcounter(\vtrace_1 \cdot \event_1' \cdot \vtrace_2'\cdot \event_2') l_2))\\
\end{array}
\right)
 \]
%
...
(\event_1', \vcounter(\vtrace_1 \cdot \event_1') l_1)\\
\bigwedge & 
  (\event_2, \vcounter(\vtrace_1 \cdot \event_1 \cdot \vtrace_2) l_2) \sigin p(\vtrace_2)
  \land 
  (\event_2, \vcounter(\vtrace_1 \cdot \event_1 \cdot \vtrace_2) l_2) \notsigin p(\vtrace_2')
\end{array}
\right)
 \]%
%
