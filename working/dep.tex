...
with hidden database $D$, denoted as 
%
$\eventdep^{val}(\event_1, \event_2, \trace_2, c, D)$, if and only if
%
\[
\exists \vtrace_0,
...
\right)
 \]%
%
$\eventdep^{\ctl}(\event_1, \event_2,  \vtrace_2, c, D)$, if and only if: 
%
\[
\exists \vtrace_1, \vtrace_2', \vtrace_0 \in \mathcal{T}, 
\event_1' \in \eventset^{\asn}, 
\event_b, \event_b' \in \eventset^{\test}, {c}_1.
\left(
\begin{array}{ll}   
  & \config{{c}, \vtrace_0} \rightarrow^{*} 
    \config{{c}_1, \vtrace_1 \cdot \event_1}  \rightarrow^{*} 
  ...
  \bigwedge &
  \config{{c}_1, \vtrace_1 \cdot \event_1'}  \rightarrow^{*} 
  \config{c_2,  \vtrace_1 \cdot \event_1 \tracecat \trace_2' \cdot \event_b'} 
  \\
  \bigwedge &  \pi_1(\event_1) = \pi_1(\event_1') \land \pi_2(\event_1) = \pi_2(\event_1') \\
  \bigwedge & l_1 = \pi_2(\event_1) \land l_2 = \pi_2(\event_2) \land l_b = \pi_2(\event_2)
  \\
  \bigwedge & \vcounter(\vtrace_2') l_b = \vcounter(\trace_2) l_b \land \diff(\event_b, \event_b') 
...
\lor
\eventdep^{\ctl}(\event_1, \event_2, \trace, c, D) 
\] %
%
\end{defn}
%
