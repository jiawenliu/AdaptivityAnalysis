%
\subsection{Trace and \todo{Post-Processed Trace}}
Trace appending:
\[
...
\begin{equation}
  ...
  \triangleq \left\{
  \begin{array}{ll} 
    \etrue                  & \trace =  (\trace' \cdot \event') \land (\event \ismeq \event') \\
    \event \ismin \trace'   & \trace =  (\trace' \cdot \event') \land (\event \ismneq \event') \\ 
    \efalse                 & o.w.
  \end{array}
  \right.
\end{equation}
