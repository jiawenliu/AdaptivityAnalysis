...
\begin{array}{l}
	...
	\eventdep^{\ctl}(\event_1, \event_2, c, D)
	\implies
	\exists \event_b = (b, l, n, v), \expr_2 \st \eventdep^{val}(\event_1, \event_b, c, D)
	\land \Big(
	\exists c_t, c_f \st (\eif ([b]{}^l, c_t, c_f)) =_{c} c \land ([\assign{x_2}{\expr_2}]^{l_2}) \in c_t;c_f
	\lor  \exists c_w \st (\ewhile [b]{}^l \edo c_w) =_{c} c \land ([\assign{x_2}{\expr_2}]^{l_2}) \in c_w
	\Big)
\end{array}
\]
\end{lem}