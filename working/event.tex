...
\mbox{Post-Processed Event} & \event & ::= & 
      (({x}, l, v), n) | (({x}, l, \qval, v), n)  ~~~~~~~ \mbox{Post-Processed Assignment Event} \\
&&& | ((\bexpr, l, v), n)   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ \mbox{Post-Processed Testing Event}
\end{array}
\]
%
\[
...
\end{defn}
%
\begin{defn}[Events Different up to Signature $\sigdiff$]
Two events $\event_1, \event_2 \in \eventset$ is \emph{D2qifferent up to signature}, 
...
\]
%
$\event_1 \eventgeq \event_2$  is defined vice versa. \wq{what is n? I see, it marks the number of times this label appears in the prefixed trace including itself. Informally, the n-th appearance of this label.  }
\end{defn}
%
%