%
%
\subsection{Event and \todo{Post-Processed Event}}
%
\[
\begin{array}{llll}
  \mbox{Post-Processed Event} 
& \event & ::= & 
      ({x}, l, n, v) | ({x}, l, n, \qval, v)  ~~~~~~~ \mbox{Assignment Event} \\
&&& | (\bexpr, l, n, v)   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ \mbox{Testing Event}
\\
%
\mbox{Post-Processed Trace} & \vtrace
...
\[
\forall i \in \{1, 2, 3\} \st \pi_{i}(\event_1) = \pi_{i}(\event_2) 
\]
...
\[
\event_1 \ismeq \event_2 \land  \pi_{4}(\event_1) \neq \pi_{4}(\event_2)
\]
\end{defn}
}
%
