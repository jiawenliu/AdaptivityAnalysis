...
\highlight{Notice both Fig.~\ref{fig:generalization_errors}(a) and Fig.~\ref{fig:generalization_errors}(c) use the same data analysis.
 One essential difference between the two figures is the use of different data sizes, mostly to account for 
