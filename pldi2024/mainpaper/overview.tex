...
This is why we also use weights. The weight of a vertex is a function that given an initial state returns a natural number representing 
...
\highlight{To do: more explanation about weight, {$\lambda \trace.1$}, and replacing replacing it  such as lastVal($\tau$, k).  }
