...
chosen by our heuristic (marked in bold) is the best in most cases.
In the setting of small parameters $k,m,n=10$ our heuristic
chooses most of the time ThresholdOut. Exceptions are examples such as $\kw{DTOVR}$,
$\kw{LROVR}$
...
chooses Gaussian mechanism.  In the setting of large parameters
$k,m,n=1000$, 
for most examples our heuristic chooses the Gaussian mechanism.
...
the \emph{Guess and Check}~\cite{RogersRSSTW20} framework our heuristic chooses the Thresholdout mechanism.
