...
\highlight{The \emph{monitor argument} is a technique to estimate the accuracy of a set of potential adaptive queries over 
the population by using only the answer of the accuracy of a carefully chosen query.}
...
\begin{figure}
\centering
\begin{subfigure}[][120pt][b]{0.3\textwidth}
    \small{
    $
\begin{array}{l}
...
\end{array}
    ...
    \caption{}
\end{subfigure}
        \begin{subfigure}[][120pt][b]{.45\textwidth}
        \begin{centering}
    ...
    % Variables Initialization
     ...
     \draw[  -latex,] (-1.2, 1)  -- (-5.5, 1) ;
     \draw[  -latex,] (-1.2, 4)  -- (-5.5, 4) ;
     \draw[  -latex,] (-1.2, 7)  -- (-5.5, 7) ;
     %
     ...
     \draw[  -latex, ] (-1.2, 4.0)  to  [out=-230,in=230]  (-0.5, 9.5);
     ...
     \draw[ -latex] (1.0, 9.5)  to  [out=-50,in=50]  (1.0, 4);
     ...
     \draw[  -latex,] (1.0, 1.0)  to  [out=50,in=-50]  (1.0, 9.5);
     % Edges Produced by Transitivity from vertext ns7 Dependency
     \draw[  -latex,] (-1.2, 7)  -- (-5.5, 1);
     \draw[  -latex,] (-1.2, 7)  -- (-5.5, 4);
     \draw[ -latex] (1.2, 7.0)  to  [out=-50,in=50]  (1.0, 1.5);
     \draw[ -latex] (1.2, 7.0)  to  [out=-50,in=50]  (1.0, 4.5);
     \end{tikzpicture}
     \vspace{-0.2cm}
     \caption{}
        \end{centering}
