...
This lemma is proved.
	...
	%
	%
\begin{customlemma}{5.2}[The Multiple-Steps Event Dependency Inversion]
...
\end{proof}
%
\input{theorem/lem_basicinversion}
%
