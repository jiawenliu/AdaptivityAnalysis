...
%       \]
%   \end{lem}
  \subsection{Proof of Uniqueness of labelled variables,Lemma~\ref{lem:lvar_unique}}
  ...
  %   $$
  %   \end{lem}
  \subsection{Proof of Trace Non-decreasing, Lemma~\ref{lem:tracenondec}}
  \label{apdx:tracenondec}
    ...
    \end{proof}
    %
    \subsection{Proof of Corollary~\ref{coro:aqintrace} from  Lemma~\ref{lem:tracenondec} }
