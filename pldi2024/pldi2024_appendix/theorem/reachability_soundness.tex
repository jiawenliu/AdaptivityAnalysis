...
\subsection{Proof of Soundness of the Abstract Events Computation, Lemma~\ref{lem:abscfg_sound}}
...
\subsection{Proof of Uniqueness of the Abstract Events Computation, Lemma~\ref{lem:abscfg_uniquex}}
