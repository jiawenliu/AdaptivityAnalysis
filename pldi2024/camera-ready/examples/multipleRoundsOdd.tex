...
\highlight{In general, $\THESYSTEM$ is not path-sensitive.}  In Fig.~\ref{fig:multiRoundsOdd}(a), %% For this program, $\THESYSTEM$ over-approximate the adaptivity.
...
the weight function \highlight{$\kw{lastVal}(\trace, \lceil  \frac{k}{2} \rceil  )$   }for the vertex $y^5$ 
