...
\begin{figure}
    ...
    \begin{subfigure}{.3\textwidth}
      \begin{centering}
      \begin{tikzpicture}[scale=\textwidth/19cm,samples=180]
% Variables Initialization
\draw[] (-6, 1) circle (0pt) node{{ $x^1: {}^1_{1}$}};
\draw[] (-6, 7) circle (0pt) node{{ $y^2: {}^{1}_{1}$}};
% Variables Inside the Loop
   \draw[] (0, 6) circle (0pt) node{{ $y^6: {}^{k}_{1}$}};
   \draw[] (0, 2) circle (0pt) node{{ $x^9: {}^{k^2}_{1}$}};
   % Counter Variables
