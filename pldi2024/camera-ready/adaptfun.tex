...
\highlight{The text description of Algorithm 1 was helpful. An example would make the lists (especially flowcapacity) clearer.}The pseudo-code of $\pathsearch_{\kw{SCC}}$ is given as Algorithm~\ref{alg:adaptscc}.
