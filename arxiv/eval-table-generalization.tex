...
{\tiny
        ...
        \multirow{2}{*}{Program $c$}
         ...
         $  \kw{decisionTree}$ & $5$ &  $1000$ & $ 1.46488979 $  & $ 1.2832855 $ & $ 1.37858806 $ &$ 1.41443426 $  \\
         $  \kw{logisticRegression}$ & $1500$ &  $k$ & $ 0.1516575 $  &   & 0.0012 & 0.0017   \\
        %  $  \kw{naiveGaussianB}$ & $100$ & $k  $ &  $ -  $  &  $-$ & $-$ & $-$ \\
        %  $  \kw{decisionTreeOVR}$ & $n\times m$ &  $2+\max(1,2k)  $ &  $ -  $  &  $-$ & $-$ & $-$ \\
         $  \kw{logisticRegressionOVR}$    & $k \times m$ &  $ k \times m $ &  $ -  $  &  $-$ & $-$ & $ 0.1516575 $ \\
