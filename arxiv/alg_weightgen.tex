...
% To compute these two quantities we use a mutually recursive procedures in a path-insensitive manner
...
% whose difference constraint may reset the variable $y$ and take the maximum value. 
