...
query from $D$ becomes deterministic. In this way, we can define the adaptivity of
...
\\
\[Adaptivity(P) \triangleq \min\limits_{P^* \in P^L}A(P^*) \]
%
\end{defn}
%
%
...
$ \Gamma \vdash^{c_1, c_2}_{M,V} P^l : \Phi \implies \Psi $, then we have:
\\
