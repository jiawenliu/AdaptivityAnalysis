...
{\textbf{$x^3: {}^{w_{x^3}}_{1}$}};
\draw[] (0, 4) circle (0pt) node {{ $a^5: {}^{w_{a^5}}_{0}$}};
\draw[] (0, 1) circle (0pt) node
{{ $l^6: {}^{w_{l^6}}_{1}$}};
% Counter Variables
\draw[] (6, 9) circle (0pt) node {\textbf{$j^1: {}^{w_{j^1}}_{0}$}};
\draw[] (6, 6) circle (0pt) node {{ $j^4: {}^{w_{j^4}}_{0}$}};
%
...
\draw[ thick, -Straight Barb] (8, 6.5) arc (150:-150:1);
