...
\end{theorem} 
 ...
 Because $\gamma ( !t)= ! \gamma(t) $ is value, unfold the definition of $\llu{!_p \tau_1}{\epsilon}$, STS: $ ! \gamma(t) \in \llu{!_p \tau_1}{v} $\\
 Unfold the definition of $\llu{!_p \tau_1}{v} $, STS: $\gamma (t) \in \llu{\tau_1}{\epsilon}$. \\
 We pick $\gamma_1$ s.t. $\gamma_1 \vDash [\Gamma] $, By ih, we get : $\gamma_1 (t_1) \in \llu{\tau_1}{\epsilon} ~(\star) $.\\
