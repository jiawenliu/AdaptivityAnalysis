...
%   { \Gamma , x: [\tau]_p \jtype{n }{}{t }{\tau }  }
   ...
   {\max(\Gamma_1, \Gamma_2)  \jtype{\max(n_1,n_2) | (n_1+n_2)}{}{\tcaseof{t}\ \{c_i \Rightarrow t_i\}_{c_i \in b} } {b} }
   
   \and
    \inferrule*[ right = case-query]
   {\Gamma_1 \jtype{n_1}{}{t}{b} \\ \Gamma_2 \jtype{n_2}{}{t_i}{query} }
   {\max(\Gamma_1, \Gamma_2) \jtype{\max(n_1,n_2)| (n_1+n_2)}{}{\tcaseof{t}\ \{c_i \Rightarrow t_i\}_{c_i \in b} } {query} }
...
%   \and
 ...
 \inferrule*[ right=E-ABS]
  ...
  { \eval{  (t_1,t_2)  }{ (F_1,F_2)  }{ \max(m_1, m_2) %m_1+m_2
  } }  
  ...
  { \eval{ \app{t_1}{t_2}  }{ F'  }{ \max(m_1+m_3, m_2 )  } }  
 ...
 \boxed{ 
  ...
  { \eval{  \letx{!x}{t_1}{t_2}  }{ F  }{ \max(m_1+m_2,m_3 )  } }  
}
...
%   { \eval{  \letx{!x}{t_1}{t_2}  }{ F  }{ m_1+m_3  } } 
  ...
  {   
    { \eval{ t  }{ (F_1,F_2)  }{m_1} } 
    \\
    { \eval{t'[F_1/x_1][F_2/x_2] }{ F}{m2 } }
  }
  { \eval{  \letx{(x_1,x_2)}{t}{t'}  }{ F  }{ \max(m_1,m_2)  } } 
  ...
  { \eval{ \tcaseof{t}\ \{c_i \Rightarrow t_i\}_{c_i \in b}  }{ \tcaseof{F}\ \{c_i \Rightarrow F_i\}_{c_i \in b}  }{  m + \max(m_i) } }
...
{
\eval{\econs(t_1,t_2)}{\econs(F_1,F_2)}{\max(m_1,m_2)}
}
