...
\begin{tabbing}
    $\mathsf{let}\, !g = ! \mathsf{fix} \, f(j). \lambda k.$ \\
...
\begin{tabbing}
    $ x: \tint \to  \tint   $ \\
    $ \cdot: \tint * \tint \to \tint $   \\
    $ g: !_1 \big(  \tint \to \tint \to \tlists{b * \tint}  \big) $\\
    $ q: \tquery $\\
    $ M: \tquery \to b $\\
\end{tabbing}
Type derivation:\\
...
\[
  \inferrule*[ right = LET-B ]
   {\Pi_L {\vartriangleright M : \tquery \to b \jtype{1}{}{! \mathsf{fix} \, f \cdots}{!_1 A}}
   \and
...
\begin{mathpar}
  \inferrule*[ right = PR ]
    ...
    {M: \tquery \to b \jtype{1}{}{! \mathsf{fix} \, f \cdots}{!_1 A}}
