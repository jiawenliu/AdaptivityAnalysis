...
\begin{figure}
  \begin{mathpar}
    \begin{array}{lll}
      \lr{\type_1 \times \type_2} & = & \lrv{\type_1}  \times \lr{\type_2} \\
      %
      \lr{\tmonad ~ \type} & = & \tmonad \lrv{\type} =  \{ d : \lr{\type} \rightarrow [0,1] \} \\
      %
      \lr{\tlist{\type}} & = & \{ \amalg_{\nnatA \in \mathbb{N}} \lr{\type} \times \dots \times \lr{\type} ~|~ \sum_{x \in \lr{\type}} d(x) = 1 \}\\
      %
      \lr{\tarr{\type_1}{\type_2}{\nnatbiA}{\dmap}{\nnatA}} & = &
