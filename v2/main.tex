...
\begin{array}{ll} 
  ...
  \mathsf{updtSC} : & \tunit \to \tlist{\treal} \to \treal \to \treal \to \tbox{ \tint \to \tint } \\
                    & \to \tlist{\tint} \to \tint[J] \to \tint \to \tlist{\tint}\\
  \mathsf{updtSCC} : & \tunit \to \tlist{\treal} \to \treal \to \treal \to \tbox{ \tint \to \tint } \\
                    & \to \tint[J] \to \tint \to \tlist{\tint}\\
  \mathsf{updtI} : & \tunit \to \treal \to \tlist{\treal} \to \tint[J] \to \tint \to \tlist{\tint}\\
...
\inferrule
  {
    ...
    {
      \Delta; \Gamma_7, D' : \tlist{\tint}; \dmap_8 \tvdash{K - J - 1} \mathsf{multiRound} \cdots : \tlist{\tint}
    }
  }
  {
    \Delta; \Gamma_7; \dmap_7 \tvdash{K - J - 1} \elet D' = \cdots \ein \cdots : \tlist{\tint}
