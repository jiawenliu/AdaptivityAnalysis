...
\begin{tabbing}
    ...
    $ g: \tarr{ \tbase }{ \tarr{\tbase}{\tlist{\treal * \tbase}}{0}{\dmap}{0} }{0}{\dmap}{0}  $\\
    $ q: \tbox{  (\tarr{ \trow }{ \treal }{0}{\dmap''}{0})     } $\\
...
Let $A = \tarr{ \tbase }{ \tarr{\tbase}{\tlist{\treal * \tbase}}{0}{\dmap}{0} }{0}{\dmap_1'}{0} $,\\
    $Q = \tbox{  (\tarr{ \trow }{ \treal }{0}{\dmap''}{0})} $,\\
    $\Gamma_0 = \eop : Q \to b$,\\
    $\Gamma = f: A, \eop : Q \to b, j: \tbase, k: \tbase, f':\tarr{\tbase}{\tlist{\treal * \tbase}}{0}{\dmap}{0} $, \\
    $\Gamma' = \Gamma, a: \treal$,\\
    $\Delta = g: A, l: \tlist{\treal * \tbase}, q:Q$.\\
\[
  \inferrule*[ right = LET-B ]
   {
     ...
     {
        \Gamma_0, \dmap' \tvdash{1} \efix \eapp  f(j). \cdots : A
      }
     \and
     \inferrule
     {
     ...
     {
      \Gamma_0, g: A, \dmap''[g : 1] \tvdash{1} \elet l = \cdots \ein \elet q = \cdots \ein \eop ( q ) : \treal
    }
     \\
     n' = \max(n_1 + 1, n_2 ) = 2
     \and
   ...
   { \Gamma_0, \dmap \tvdash{2} \elet g = \cdots \ein \elet l = \cdots \ein \cdots :  \treal }
\]
...
\begin{mathpar}
      \inferrule*[right = FIX]
      {
        \inferrule*[right = FIX]
        {
          \inferrule*[right = IF]
          {
            ...
            \nnatA' = \nnatA_0 + \nnatA_1 = 0 + 1 = 1
            \and
            \dmap_1' = \max(\dmap_3' + 0 , [j:0, k:0])
          }
          {
            \Gamma;  \dmap_2'[f': \infty, k: 0] 
            \tvdash{1} \eif \cdots : \tlist{\treal * \tbase}
          }
        }
        {
          \Gamma_0, f: A, j : \tbase; \dmap_1'[f: \infty, j: 0] \tvdash{1} {\lambda k. \eif \cdots : \tarr{\tbase}{\tlist{\treal * \tbase}}{0}{\dmap}{0} }
        }
      }
      {
        \Gamma_0, \dmap' \tvdash{1} \efix \eapp  f(j). \cdots : A 
    ...
    \inferrule
        {
         \inferrule
            ...
            {
                \Gamma \tvdash{0} \lambda x. (x \eapp j)\cdot (x \eapp k) : Q
            }
        }
        {
    ...
    \inferrule
        ...
        \inferrule*[right = APP]
            ...
            {
                \Gamma'; \dmap_7' \tvdash{0} f \eapp  j+1 \eapp  k : \tlist{\treal * \tbase}
            }
            \\
            \nnatA' = \max(\nnatA_1, \nnatA_2) = 0
            \and
            \dmap_5' = \max(\dmap_6', \dmap_7')
        }
        {
            \Gamma'; \dmap_5'[a: 0] \tvdash{0} 
            (a, j) ::(\cdots) : \tlist{\treal * \tbase}
        }
      \\
      \nnatA' = \max(\nnatA_2, \nnatA_1 + q) = 1
      \and
      \dmap_3' = \max(\dmap_4' + 0, \dmap_5')
    }
    {
    ...
    \inferrule*[right = APP]
    {
      ...
      {
      \Gamma'; \dmap_7' \tvdash{0} j + 1: \tbase
      }
      \\
      \nnatA' = \max(\nnatA_2 + q, \nnatA) + \nnatA_1 = 0     
      }
      {
      \Gamma'; \dmap_7' \tvdash{0} f \eapp j+1 : \tarr{\tbase}{\tlist{\treal * \tbase}}{0}{\dmap}{0}
      }
      \and
      \inferrule*[right = VAR]
      {
...
\inferrule*[right = LET]
    ...
    \inferrule
    {
      \inferrule
      {
        ...
        {
            \Gamma_0, g: A ; \dmap_1'' \tvdash{0} {g : Q }
        }
        \and
        \inferrule
        {
        ...
        {
          \Gamma_0, g: A; \dmap_1'' \tvdash{0} K : \tbase
        }
      }
      {
         \Gamma_0, g: A; \dmap_1'' \tvdash{0} {g \eapp  0  : \tlist{\treal * \tbase}}
      }
      \and
      \inferrule
      {
    ...
    {
        \Gamma_0, g: A; \dmap_1'' \tvdash{0} { g \eapp  0 \eapp  K : \tlist{\treal * \tbase}}
    }
    \and
    \cdots
    \\
    ...
    \inferrule*[right = LET]
        ...
        \inferrule*[right = FIX]
            ...
            \inferrule
                ...
                {
                    \Gamma_0,  \Delta; \dmap_5''[x:0] \tvdash{0} {\mathsf{sign}(\dots) :  \treal}
                }
                \\
                \nnatA' = \nnatA_1 + \max(\nnatA_2 + q, \nnatA) = 0               
            }
            {
                \Gamma_0, \Delta; \dmap_5''\tvdash{0} {\lambda x. \dots : Q}
            }
        \inferrule
          {
          \inferrule
              ...
              {
                  \Gamma_0, \Delta_0 \tvdash{0} { q : Q}
              }
          }
          {
                  \Gamma_0, \Delta; \dmap_4''[q : 1] \tvdash{1} {\eop (q) : \treal}
          }
          \\
          \nnatA' = \max(\nnatA_1 + q, \nnatA_2) = 1
        }
        {
            \Gamma_0, \Delta; \dmap_2''[l: 1]  \tvdash{1} \elet q = \cdots \ein \cdots : \treal
        }
