...
$\dmap$. We also lift $\max$ and $+$ pointwise to depth maps, and
define the constant map $\dmapb$ that maps everything to $\bot$. These
are also fomally defined in Figure~\ref{fig:type-rules}.
...
\begin{figure}
  \begin{mathpar}
    ...
    \inferrule{
      ...
      \Gamma; \dmapb \tvdash{0} \efix f(x).\expr: (\tarr{\type_1}{\type_2}{\nnatbiA}{\dmap}{\nnatA})
    }
    %
    \and
    %
    ...
    \inferrule{
      ...
      \Gamma; \dmap \tvdash{0} \efalse: \tbool
    }
    %
    \and
    %
    ...
    \inferrule{
      ...
      \Gamma; \dmap \tvdash{0} \econst: \tbase
    }
    %
    \and
    %
