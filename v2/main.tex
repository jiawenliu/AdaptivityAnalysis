...
\]
%
Assume $(k, \env) \in \lrv{\Gamma} ~ (\square)$, TS: $(k, (\env, \expr_1, \expr_2)) \in \lre{\nnatA'}{\dmap'}{\type_2}$.\\
%
By inversion, pick $\valr, \tr, j$ s.t. $((\env, \expr_1 \expr_2) \bigstep (\valr, \tr)) \land (\size{\tr} = j) \land (j \leq k) $.\\
%
...
Pick any $\valr_1, \tr_1$, s.t. $((\env, \expr_1) \bigstep (\valr_1, \tr_1)) \land (\size{\tr_1}) $
