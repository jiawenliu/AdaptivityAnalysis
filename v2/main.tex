   ...
   \begin{mathpar}
    ...
    %
     \inferrule{
      ...
      \models \sub{\tbool}{\tbox{\tbool} }
    }
    %
    \and
    %
    \inferrule{
     \models \sub{\type_1 }{ \type_1'  } \\
         \models \sub{\type_2 }{ \type_2'  }
    }{
       \models \sub{\type_1 \times \type_2 }{ \type_1' \times \type_2'  }
    }
    %
    \and
    %
    ...
    %
     \inferrule{
       ...
       \models \sub{\tarr{\type_1}{\type_2}{0}{\dmap'}{0} }{  \tbox{(
          \tarr{\type_1}{\type_2}{\nnatbiA}{\dmap}{\nnatA} )  }
    } }
    %
    \and
  ...
  \and
    %
     \inferrule{
       ...
       \models \sub{ \tbox{\tau}  }{ \tau }
    }
  \and
    %
     \inferrule{
    }{
       \models \sub{ \tbox{\tau}  }{ \tbox{\tbox{\tau}} }
    }
  \and
    %
     \inferrule{
         \models \sub{ \tau_1  }{ \tau_2 }
    }{
       \models \sub{ \tbox{\tau_1}  }{ \tbox{\tau_2} }
    }
  \and
    %
 ...
 \and
    %
     \inferrule*[right=tran]{
         \models \sub{ \tau_1  }{ \tau_2 } 
        \\
          \models \sub{ \tau_2  }{ \tau_3 }
    }{
       \models \sub{ \tau_1  }{ \tau_3 }
    }
    \end{mathpar}
...
\boxed{
    \inferrule
    {
        \Delta; \Gamma; \dmap \tvdash{\nnatA} \expr: \type 
           \\
        \forall x \in \dom(\Gamma), \sub{\tbox{\Gamma(x)}}{\Gamma(x)}
           \\
        \delta \not\in \expr
    }
    {
