      ...
      \inferrule*[right = FIX]
      {
        \inferrule*[right = FIX]
        {
          \inferrule*[right = IF]
          {
            ...
            {
              \Gamma; [j:0, k:0] \tvdash{0} {j<k : \tbool}
            }
            \\
            \inferrule*[right = LET]
            {
            ...
            {
              \Gamma; \dmap_3' \tvdash{1} \elet a = \eop ( \cdots ) \ein (a, j) :: \cdots : \tlist{\treal * \tbase}
            }
            \\
            \inferrule*[right = NIL]
            {
            ...
            {
              \Gamma; \dmap_3' \tvdash{1} {[] : \tlist{\treal * \tbase}}
            }
            \\
            \nnatA' = \nnatA_0 + \nnatA_1 = 0 + 1 = 1
            \and
            \dmap_2' = \max(\dmap_3' + 0 , [j:0, k:0])
          }
          {
            \Gamma ;  \dmap_2'[k: 0] 
        ...
        {
          f: A, j : \tbase; \dmap_1'[f: \infty, j: 0] \tvdash{1} {\lambda k. \eif \cdots : \tarr{\tbase}{\tlist{\treal * \tbase}}{1}{[j:0]}{1} }
        }
      }
      {
        \dmap' \tvdash{1} \efix \eapp  f(j). \cdots : A 
    ...
    \inferrule
        {
         \inferrule
            ...
            {
                \Gamma; \dmap_9' \tvdash{0} \lambda x. (x \eapp j)\cdot (x \eapp k) : Q_1
            \\\\
            \dmap_4' = \dmap_9' + 1
            }
        }
        {
            \Gamma; \dmap_4' \tvdash{1} \eop ( \lambda x. (x \eapp j)\cdot (x \eapp k)) : \treal
        }
    \and 
    \inferrule
        {
        \inferrule
            ...
            {
                \Gamma'; \dmap_6' \tvdash{0} (a, j) : \treal * \tbase
            }
            \\
        \inferrule*[right = APP]
            {
            ...
            {
                \Gamma'; \dmap_7' \tvdash{1} f \eapp  j+1 \eapp  k : \tlist{\treal * \tbase}
            }
            \\
            \nnatA' = \max(\nnatA_1, \nnatA_2) = 1
            \and
        ...
        {
            \Gamma'; \dmap_5'[a: 0] \tvdash{1} 
            (a, j) ::(\cdots) : \tlist{\treal * \tbase}
        }
      \\
      \nnatA' = \max(\nnatA_2, \nnatA_1 + q) = 1
      \and
      \dmap_3' = [x:1, j:1, k:1, f:\infty]
    }
    {
      \Gamma; \dmap_3'  \tvdash{1} 
...
\begin{mathpar}
    ...
    \inferrule*[right = APP]
    {
      ...
      {
      \Gamma'; \dmap_8' \tvdash{0} f \eapp j+1 : \tarr{\tbase}{\tlist{\treal * \tbase}}{1}{[j:1]}{1}
      }
      \and
      \inferrule*[right = VAR]
      {
...
\inferrule
{
  \inferrule
  {
    \inferrule
    {
      ...
      {
        \Gamma''; \dmap_{11}' \tvdash{0} (x \eapp j) : \treal
      }
      \and
       \inferrule
      {
        ...
        \\\\
        \dmap_{12}' = [x: \infty, k:0]
      }
      {
        \Gamma''; \dmap_{12}' \tvdash{0} (x \eapp k) : \treal
      }
      \\
      \dmap_{10}' = [x: 0, k:0, j : 0]
    }
    {    
      \Gamma''; \dmap_{10}' \tvdash{0} (x \eapp j) \cdot (x \eapp k) : \treal
      \and
      \dmap_{9}' = \dmap_{10}'
    }  
  }
  {
    \Gamma; \dmap_9' \tvdash{0} \lambda x. (x \eapp j)\cdot (x \eapp k) : \tarr{\trow}{\treal}{0}{[j:0,k:0]}{0}
  }
}
{
  \Gamma; \dmap_9' \tvdash{0} \lambda x. (x \eapp j)\cdot (x \eapp k) : Q_1
...
\inferrule*[right = LET]
    ...
    \inferrule
    {
      \inferrule
      {
        ...
        {
          g: A; [0: 0] \tvdash{0} 0 : \tbase
        }
        \\\\
        \dmap_2'' = [g: 0, 0:0]
      }
      {
         g: A; \dmap_2'' \tvdash{0} {g \eapp  0  : \tarr{\tbase}{ \tlist{\treal * \tbase}}{1}{[j:1]}{1} }
      }
      \and
      \inferrule
      {
      ...
      {
        g: A; [K:0] \tvdash{0} K : \tbase
      }
        \\
        \dmap_1'' = [g: 0, 0:0, j:1, K:1]
    }
    {
        g: A; \dmap_1'' \tvdash{1} { g \eapp  0 \eapp  K : \tlist{\treal * \tbase}}
    }
    \and
    \cdots
    \\
    \nnatA' = \max(\nnatA_1 + q, \nnatA_2) = 2
    \and
    \dmap'' = \max((\dmap_1'' + 1), \dmap_4'')
    }
    {
    g: A; \dmap'' \tvdash{2} \elet l = \cdots \ein \elet q = \cdots \ein \eop ( q ) : \treal   
    }
    ...
    \inferrule*[right = LET]
        ...
        \inferrule
            ...
            \inferrule
            {
              \inferrule
                  ...
                  {
                      \Delta''; \dmap_5'' \tvdash{0} {\mathsf{sign}(\dots) :  \treal}
                  }          
            }
            {
                \Delta; \dmap_5''\tvdash{0} {\lambda x. \dots : \tarr{\trow}{\treal}{0}{[l:0]}{0} }
            }
            }
            {
                \Delta; \dmap_5''\tvdash{0} {\lambda x. \dots : Q_1}
            }
        \and
        \inferrule
          {
          \inferrule
              ...
              {
                  \Delta'; [q: 0] \tvdash{0} { q : Q_2}
              }
          }
          {
                  \Delta'; [q : 1] \tvdash{1} {\eop (q) : \treal}
          }
          \\
          \nnatA' = \max(\nnatA_1 + q, \nnatA_2) = 1
          \\
        ...
        {
            \Delta; \dmap_4''  \tvdash{1} \elet q = \cdots \ein \cdots : \treal
        }
...
\inferrule
{
  ...
  {
    \Delta, x: \trow; [\mathsf{sign}:0] \tvdash{0} \mathsf{sign} :  \treal \to \treal
  }
  \and
  \inferrule
  {
    ...
    {
      \Delta''; \dmap_6'' \tvdash{0} \mathsf{foldl}(\cdots) \eapp 0 : \tlist{\tbase * \treal} \to \treal
    }
    \\
    \inferrule
    {
  ...
  {
    \Delta''; \dmap_6''[l:0] \tvdash{0} \mathsf{foldl}(\cdots) \eapp 0 \eapp l : \treal 
  }
}
{
  \Delta''; \dmap_6''[l:0][\mathsf{sign}:0] \tvdash{0} \mathsf{sign}(\dots) :  \treal
}
...
\inferrule
{
  \inferrule
  {
    ...
    {
      \Delta''; [\mathsf{foldl}:0] \tvdash{0} \mathsf{foldl} : FL
    }
    \and
    \inferrule
    {
    ...
    {
      \Delta''; \dmap_8'' \tvdash{0} \lambda acc. \cdots : FL2
    }
  }
  {
    \Delta''; \dmap_7'' \tvdash{0} \mathsf{foldl}(\cdots) :FL1 
    \and
    \dmap_7'' = \dmap_8''[\mathsf{foldl} : 0] 
  }
  \and
  \inferrule
  {
  ...
  {
    \Delta''; [0:0] \tvdash{0} 0 : \tbase
  }
}
{
  \Delta''; \dmap_7''[0:0] \tvdash{0} \mathsf{foldl}(\cdots) \eapp 0 : \tlist{\tbase * \treal} \to \treal
}
...
\inferrule
{
  \inferrule
  {
    \inferrule
    {
      ...
      {
        \Delta_2''; \dmap_{10}'' \tvdash{0} acc: \treal
      }
      \and
      \inferrule
      {
        ...
        {
          \Delta_2''; \dmap_9'' \tvdash{0} x \eapp i: \treal
          \and
          \dmap_9'' = [x:0, i:0]
        }
        \and
      ...
      {
        \Delta_2''; [x:0, i:0, a:0] \tvdash{0} (x\eapp i) * \cdots: \treal
      }
    }
    {
      \Delta_2''; [acc:0] \tvdash{0} acc + \cdots : \treal
      \\
      \Delta_2'' = \Delta_1'', (a,i): \tlist{\treal * \tbase} 
    }
  }
  {
    \Delta_1''; \dmap_8'' \tvdash{0} \lambda (a,i). \cdots :  \to \treal
    \and
    \Delta_1'' = \Delta'', acc: \treal
    \and
    \dmap_8'' = [x:0, i:0, a:0, acc:0]
  }
}
{
  \Delta''; \dmap_8'' \tvdash{0} \lambda acc. \cdots : FL2
...
\begin{figure}
  \begin{mathpar}
    ...
    {
      \Gamma \tvdash{\nnatA} \uniform \eapp \valr_1 \eapp \valr_2: \treal
    }
    %
  \end{mathpar}
...
\begin{array}{ll} 
  \mathsf{multiRound} :& \tunit \to \forall \eapp k. \forall \eapp j. \tlist{\treal} \to \tlist{\treal} \to \tlist{\tint} \\
                        & \to \tint \to \tint \to \tint \to \tint \to \tarr{\tlist{\tint}}{\tlist{\tint}}{k-j}{\dmap}{k - j} \\
...
\inferrule*[right = FIX]
{
  \inferrule*[right = FIX]
  {
    \inferrule*[right = IF]
    {
      ...
      {
        \Gamma; \dmap_1 \tvdash{k - j} \elet p = \cdots \ein \cdots : \tlist{\tint}
      }
      \and
      \inferrule
      {
      ...
      {
        \Gamma; [D: 0] \tvdash{0} D : \tlist{\tint}
      }
    }
    {
      \Gamma_0', sc: \tlist{\treal}, \cdots; \dmap_0 
      \tvdash{0} \eif(j<k, \elet p = \cdots \ein \cdots, D) : \tlist{\tint}   
    }
  }
  {
  \Gamma_0 , \mathsf{multiRound} : \tunit \to \cdots; \dmap_0
  \tvdash{k - j} \Lambda. \Lambda. \cdots : \forall. \forall. \cdots  
  }
}
{
  \Gamma_0; \dmap_0 \tvdash{k - j} \efix \mathsf{multiRound ()}. \cdots : \tunit \to \cdots
}
...
\inferrule*[right = LET]
{
  ...
  {  
    \Gamma; [\_:0] \tvdash{0} \uniform \eapp 0 \eapp 1 : \treal
  }  
  \and
  \inferrule
  {
  ...
  {
    \Gamma, p : \treal; \dmap_2 \tvdash{k - j} \elet q = \lambda x. \cdots \ein \cdots : \tlist{\tint}
  }
}
{
  \Gamma; \dmap_1 \tvdash{k - j} \elet p = \cdots \ein \cdots : \tlist{\tint}
...
\inferrule*[right = LET]
{
  \inferrule
  {
    \inferrule
    {
      ...
      {
        \Gamma_{1}, x: \tint; [ \_ : 0] \tvdash{0} \bernoulli \eapp p : \tint
      }
    }
    { 
      \Gamma_{1}; [ \_ : 0] \tvdash{0} \lambda x. \bernoulli \eapp p : \tint \to \tint
    }
  }
  {
    \Gamma_{1}; [ \_ : 0] \tvdash{0} \lambda x. \bernoulli \eapp p : \tbox{\cdots}
  }
  \and
  \inferrule
  {
    \inferrule
    {
      ...
      {
        \Gamma_{3}; \dmap_4 \tvdash{k - j} \elet a = \eop ( q ) \ein \cdots : \tlist{\tint}
      }
    }
    {
      \cdots
  ...
  {
    \Gamma, q: \tbox{\cdots}; \dmap_3 \tvdash{k - j} \elet qc = \lambda x. \cdots : \tlist{\tint}
  }
}
{
  \Gamma_{1}; \dmap_2 \tvdash{k - j} \elet q = \lambda x. \bernoulli \eapp p \ein \cdots : \tlist{\tint}
}
\end{mathpar}
...
{ 
  \inferrule
  {
    \inferrule
    {
      ...
      {
        \Gamma_4;[\_ : \infty] \tvdash{0} \mathsf{updtSC} : \cdots
      }
      \\\\
      \inferrule
      {
  ...
  \inferrule
  {
    ...
    {
      \Gamma_7; \dmap_7 \tvdash{k - j - 1} \elet D' = \cdots \ein \cdots : \tlist{\tint}
    }
  }
  {
    \cdots
...
{
  \Gamma_3, a: \treal; \dmap_5 \tvdash{k - j - 1} \elet sc' = \mathsf{updtSC} \cdots \ein \cdots : \tlist{\tint}
}
\end{mathpar}
...
\inferrule
  {
    ...
    {
      \Gamma_7; [\_ : 0] \tvdash{0} D \setminus I' : \tlist{\tint}
    }
    \and
    \inferrule
    {
    ...
    {
      \Gamma_7, D' : \tlist{\tint}; \dmap_8 \tvdash{k - j - 1} \mathsf{multiRound} \cdots : \tlist{\tint}
    }
  }
  {
    \Gamma_7; \dmap_7 \tvdash{k - j - 1} \elet D' = \cdots \ein \cdots : \tlist{\tint}
    ...
    \inferrule
{
  ...
  {  
    \inferrule
    {
      ...
      {
        \Gamma_8; [\mathsf{multiRound}: \infty] \tvdash{0} \mathsf{multiRound} : \cdots
      }
      \\\\
      \inferrule
      {
  ...
  {
    \Gamma_8; [\_ : 0] 
    \tvdash{0} \mathsf{multiRound} \eapp () \eapp \Lambda. \Lambda. \cdot : \tarr{\cdot}{\cdot}{k - (j + 1)}{\dmap'}{k - (j + 1)}
  }
  \and
  \inferrule
  {
  ...
  {
    \Gamma_8; [\_:0] \tvdash{0} D' : \tlist{\tint}
  }
}
{
  \Gamma_7, D' : \tlist{\tint}; \dmap_8 
...
\[
\begin{array}{ll}
\dmap   & : [sc : k - j, scc : k - j, I : k - j, j : 0, k : 0, N : 0, C: 0, D : k - j] \\
\dmap'  & : [sc' : k - j - 1, scc' : k - j - 1, I' : k - j - 1, (j + 1) : 0, k : 0, N : 0, C: 0, D' : k - j - 1] \\
\dmap_8 & : \dmap'[\mathsf{multiRound}: \infty, D' : k - j - 1]   \\
\dmap_7 & : \dmap'[\mathsf{multiRound}: \infty, D : k - j - 1]   \\
\dmap_6 & : [\mathsf{updtSC} : \infty, () : 0, sc : 0, a : 0, p : 0, q : 0, I : 0, i : 0, N : 0]\\
\dmap_5 & : [sc : k - j - 1, scc : k - j - 1, I : k - j - 1, a : k - j - 1, p : k - j - 1,\\
        &    q : k - j - 1, (j + 1) : 0, k : 0, N : 0, C: 0, D : k - j - 1 ]\\
\dmap_4 & : [sc : k - j - 1, scc : k - j - 1, I : k - j - 1, p : k - j - 1,\\
        &    q : k - j - 1, (j + 1) : 0, k : 0, N : 0, C: 0, D : k - j ]\\
\end{array}
\]
