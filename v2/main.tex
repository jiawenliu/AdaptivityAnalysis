...
\begin{figure}
 ...
 \and
    %
    \inferrule{
      \Gamma; \dmap \tvdash{\nnatA} \expr:  \tbox{  (\tarr{ \text{row}
        }{ \mathbb{R} }{0}{\dmap''}{0})     }   \\
      \forall x \in \dmap''. \dmap''(x) = 0 \\
      \nnatA' = 1 + \nnatA \\
      \dmap' = 1 + \dmap
    }{
      \Gamma; \dmap' \tvdash{\nnatA'} \eop(\expr): \mathbb{R}
    }
  \end{mathpar}
...
\[
\begin{array}{l}
 \elet \, \mathsf{g} = \efix \, f(j). \lambda k.  \\
 \hspace{.2cm} \eif \big (  (j < k)  ,  \\
  \hspace{.8cm} \elet \, a = \eop \, \boxed{( \lambda x. (x \,j)\cdot (x \,k) )}  \, \ein \\
  \hspace{1.2cm} (a, j) :: (f  \,(j+1) \, k) \\
 \hspace{1.2cm} , \, [] \big) \\
  \hspace{.2cm} \ein \\
  \elet \, l = \mathsf{g} \, 0\, K \, \ein \\
  \elet \,  q =  \lambda x. \mathsf{sign} \, (\mathsf{foldl} \, (\lambda acc. \lambda (a,i). \big(acc\,+ (x \, i) *lg(\frac{1+a}{1-a})  \big) \, 0 \, l )) \, \ein \\
  \eop ( q )
\end{array}
\]
\end{figure}
...
Let $A = \big( \tbase \to \tbase \to \tlist{b * \tbase} \big) $, $\Gamma = f: A, M : \tquery \to b, j: \tbase, k: \tbase\ $, $\Gamma_0 = M : \tquery \to b$, $[\Delta]_i = g: [A]_i, l:[\tlist{b*\tbase}]_i, q:[\tquery]_i$.\\
\[
  \inferrule*[ right = LET-B ]
   {\Pi_L {\vartriangleright M : \tquery \to b \tvdash{\nnatA} ! \mathsf{fix} \, f \cdots: !_1 A}
   \and
   \Pi_R {\vartriangleright M : \tquery \to b, g: [A]_1 \tvdash{\nnatA} {\elet l = g \, 0\, K \ein \elet q = \cdots \ein \cdots}{b}}
   }
   { M: \tquery \to b \tvdash{\nnatA} {\elet g = \cdots \ein \elet l = \cdots \ein \cdots}{\tbase}}
\]
  ...
  \inferrule
      ...
      \inferrule
      {
        \inferrule
        {
          \inferrule
          {
            ...
            {
              \Gamma \tvdash{\nnatA} {\elet a = M \, ( \cdots )}{(a, j) :: \cdots}: \tlist{b*\tbase}
            }
            \and
            \inferrule*[right = NIL]
            {
          ...
          {
            f: A, M : \tquery \to b, j: \tbase, k: \tbase \tvdash{\nnatA} \mathsf{if} \cdots: \tlist{b*\tbase}
          }
        }
        {
          f: A, M : \tquery \to b\ \tvdash{\nnatA} {\lambda\, j. \lambda\, k. \mathsf{if} \cdots}{\tbase \to \tbase \to \tlist{b*\tbase}}
        }
      }
      {
        M: \tquery \to b \tvdash{\nnatA} {\mathsf{fix} \, f \cdots}{ A} 
      }
    }
    {
      M: \tquery \to b \tvdash{\nnatA} \mathsf{fix} \, f \cdots: !_1 A
    ...
    \inferrule*[right = MT]
        {
         \inferrule*[right = QUERY]
            ...
            {
                \Gamma \tvdash{\nnatA} { \lambda x. (x \,j)\cdot (x \,k)}{\tquery}
            }
        }
        {
            \Gamma \tvdash{\nnatA} {M\, ( \lambda x. (x \,j)\cdot (x \,k))}{b}
        }
    \and 
    \inferrule*[right = CONS]
        ...
        \inferrule*[right = APP]
            ...
            {
                \Gamma, a: b \tvdash{\nnatA} {(f \, j+1 \, k) }{\tlist{b*\tbase}}
            }
        }
        {
            \Gamma, a: b \tvdash{\nnatA} {(a, j) ::(f \, j+1 \, k) }{\tlist{b*\tbase}}
        }
    }
    {
      \Gamma \tvdash{\nnatA} \elet a = M\, ( \lambda x. (x \,j)\cdot (x \,k)) = (a, j) ::(f \, j+1 \, k): \tlist{b*\tbase}
    }
    \end{mathpar}
    ...
    \inferrule*[right = LET-B]
        ...
        \inferrule*[right = PR]
            ...
            \inferrule*[right = ABS]
                ...
                {
                    \tvdash{\nnatA} {\lambda x. \dots}{row \to b}
                }
            }
            {
                \tvdash{\nnatA} {!\lambda x. \dots}{!_1 row \to b}
            }
        \inferrule*[right = MT]
          {
          \inferrule*[right = QUERY]
              ...
              {
                  \Gamma_0, \Delta_0 \tvdash{\nnatA} {q}{\tquery}
              }
          }
          {
                  \Gamma_0, [\Delta]_1 \tvdash{\nnatA} {M(q)}{b}
          }
        }
        {
            \Gamma_0, g: [A]_1, l:[\tlist{b*\tbase}]_1  \tvdash{\nnatA} \elet q = \cdots \ein \cdots : b
        }
    }
    {
        \Gamma_0, g: [A]_1 \tvdash{\nnatA} \elet l = ! g \, 0\, K \ein \elet q =  \dots \ein \dots  : b
    }
\end{mathpar}
