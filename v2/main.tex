...
\begin{mathpar}
  ...
  %
  \and
  \wq{?~  \inferrule{ }{\env, \bernoulli \eapp \expr \bigstep \econst, \econst} }
  \and
 \inferrule{ }{\env, \uniform \eapp \expr_1 \eapp
      \expr_2\bigstep \econst, \econst} 
  \and
  %
  \wq{ \inferrule{
  }{
...
{
	\Delta; \Gamma; \dmap \tvdash{\color{red} \nnatA }  \infr{x}{\type}{\dmap(x) \geq 0}
}
%
\quad
%
...
{
	\Delta; \Gamma; \dmap \tvdash{\color{red} 0 } \infr{c}{\tbase}{\bot}
}
%
\quad
%
...
{
	\Delta; \Gamma; \dmap \tvdash{\color{red} 0} \infr{\enil}{ \tlist{\type} }{\bot}
}
%
\and
%
...
{
	\Delta; \Gamma; \dmap \tvdash{\color{red} 0 } \infr{\etrue}{\tbool}{\bot}
}
%
\quad
%
...
{
	\Delta; \Gamma; \dmap \tvdash{ \color{red} 0} \infr{\efalse}{\tbool}{\bot}
}
%
\and
%
...
\inferrule
{
	...
	\and
	\Delta; \Gamma; \dmap_2 \tvdash{\nnatA_2} \chec{\expr_2}{\type_1}{\restriction_1}
}
{
	\Delta; \Gamma; \dmap'  \tvdash{\nnatA'} 
...
\inferrule
{
	\Delta; \Gamma; \dmap \tvdash{\nnatA} \chec{\expr}{\type_1 \times \type_2}{\restriction}
}
{
	\Delta; \Gamma; \dmap \tvdash{\nnatA} \chec{\eprojl(\expr)}{\type_1}{\restriction}
}
%
\and
%
...
{
	\Delta; \Gamma; \dmap \tvdash{\nnatA} \chec{\eprojr(\expr)}{\type_2}{\restriction}
}
%
\and
%
\inferrule
{
	\Delta; \Gamma; \dmap \tvdash{\nnatA_1} \infr{\expr_1}{\tbool}{\restriction_1}
	\and
	\Delta; \Gamma; \dmap \tvdash{\nnatA} \chec{\expr_2}{\type}{\restriction_2}
	\and
	\Delta; \Gamma; \dmap \tvdash{\nnatA} \chec{\expr_3}{\type}{\restriction_3}
}
{
...
{
	\Delta; \Gamma; \dmap \tvdash{\nnatA} 
	\infr{\expr}{ \tbox{\tarr{\type_1}{\type_2}{0}{\dmap''}{0} } }{\restriction}
}
{
	\Delta; \Gamma; \dmap' \tvdash{\nnatA'}
	\chec{\eop{\expr}}{\treal}
...
{
	\Delta; \Gamma; \dmap \tvdash{\nnatA} \chec{\expr}{\tbox{\type}}{\restriction}
}
}
%
\and
...
\inferrule
{
	\Delta; \Gamma; \dmap_1 \tvdash{\nnatA_1} \infr{\expr_1}{\type_1}{\restriction}
	\and
	\Delta; \Gamma, x : \type_1; \dmap_2[x: \nnatbiA] \tvdash{\nnatA_2} 
...
\inferrule
{
	\Delta; \Gamma; \dmap \tvdash{ \nnatA } \infr{\expr}{ \tforall{\dmap_1 }{\nnatA_1}{i} }{ \restriction }
	\and
	\Delta \tvdash{} I :: S
}
{
	\Delta; \Gamma; \dmap' \tvdash{ \nnatA } \infr{\expr [ ]}{ \type[I/i] }
	{
