...
\[
\begin{array}{ll} 
  \mathsf{multiRound} : & \tunit \to \tlist{\treal} \to \tlist{\treal} \to \tlist{\tint} \\
                        & \to \tint \to \tint \to \tlist{\tint} \to \tint \to \tint \to \tlist{\tint} \\
...
\inferrule*[right = FIX]
{
  \inferrule*[right = FIX]
  {
    \inferrule*[right = IF]
    {
      ...
      {
        \Gamma \tvdash{0} \elet p = \cdots \ein \cdots : \tlist{\tint}
      }
      \and
      \inferrule
      {
      ...
      {
        \Gamma \tvdash{0} D : \tlist{\tint}
      }
    }
    {
      \mathsf{multiRound} : \cdots, sc: \tlist{\treal}, \cdots 
      \tvdash{0} \eif(j<k, \elet p = \cdots \ein \cdots, D) : \tlist{\tint}   
    }
  }
  {
  \mathsf{multiRound} : \tunit \to \cdots \to \tlist{\tint}
  \tvdash{0} \lambda sc. \cdots : \tlist{\treal} \to \cdots \to \tlist{\tint}  
  }
}
{
  \Gamma_0 \tvdash{0} \efix \mathsf{multiRound ()}. \cdots : \tunit \to \cdots \to \tlist{\tint}
}
...
\inferrule*[right = LET]
{
  ...
  {
    \Gamma, p : \treal \tvdash{0} \elet q = \lambda x. \cdots \ein \cdots : \tlist{\tint}
  }
}
{
  \Gamma \tvdash{0} \elet p = \cdots \ein \cdots : \tlist{\tint}
...
\inferrule*[right = LET]
{
  \inferrule
  {
    \inferrule
    {
      ...
      {
        \Gamma_{1}, x: \tint \tvdash{0} \bernoulli \eapp p : \tint
      }
    }
    { 
  ...
  {
    \Gamma_{1} \tvdash{0} \lambda x. \bernoulli \eapp p : \tbox{\tint \to \tint}
  }
  \and
  \inferrule
  {
    \inferrule
    {
      \inferrule
      {
        \inferrule
        {
          ...
          {
            \Gamma_{3} \tvdash{0} q : \tbox{\tint \to \tint}
          }
        }
        { 
          \Gamma_{3} \tvdash{0} \eop (q): \treal
        }
        \and
        \Pi_1  \vartriangleright
      }
      {
        \Gamma_{3} \tvdash{0} \elet a = \eop ( q ) \ein \cdots : \tlist{\tint}
      }
    }
    {
      \cdots
  ...
  {
    \Gamma, q: \tbox{\tint \to \tint} \tvdash{0} \elet qc = \lambda x. \cdots : \tlist{\tint}
  }
}
{
  \Gamma_{1} \tvdash{0} \elet q = \lambda x. \bernoulli \eapp p \ein \cdots : \tlist{\tint}
}
\end{mathpar}
...
{ 
  \inferrule*[right = APP]
  {
    \inferrule
    {
      ...
      {
        \Gamma_4 \tvdash{0} \mathsf{updtSC} : \cdots
      }
      \and
      \inferrule
      {
  ...
  {
    \Gamma_4 \tvdash{0} \mathsf{updtSC} \eapp () \eapp sc \eapp a \cdots : \tlist{\treal}
  }
  \and
  \inferrule
  {
    ...
    {
      \Gamma_7 \tvdash{0} \elet D' = \cdots \ein \cdots : \tlist{\tint}
    }
  }
  {
    \cdots
...
{
  \Gamma_3, a: \treal \tvdash{0} \elet sc' = \mathsf{updtSC} \cdots \ein \cdots : \tlist{\tint}
}
\end{mathpar}
...
\inferrule
  {
    ...
    {
      \Gamma_7 \tvdash{0} D \setminus I' : \tlist{\tint}
    }
    \and
    \inferrule
    {
    ...
    {
      \Gamma_7, D' : \tlist{\tint} \tvdash{0} \mathsf{multiRound} \eapp () \cdots : \tlist{\tint}
    }
  }
  {
    \Gamma_7 \tvdash{0} \elet D' = \cdots \ein \cdots : \tlist{\tint}
