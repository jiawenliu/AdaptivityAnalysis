...
\begin{array}{ll} 
  \mathsf{multiRound} :& \tunit \to \forall \eapp k. \forall \eapp j. \tlist{\treal} \to \tlist{\treal} \to \tlist{\tint} \\
                        & \to \tint \to \tint \to \tlist{\tint} \to \tint \to \tarr{\tint}{\tlist{\tint}}{k-j}{[ \_ :0]}{k - j} \\
...
\inferrule
  {
    ...
    {
      \Gamma_7, D' : \tlist{\tint} \tvdash{k - j - 1} \mathsf{multiRound} \eapp () \cdots : \tlist{\tint}
    }
  }
  {
    \Gamma_7; \dmap_7 \tvdash{k - j - 1} \elet D' = \cdots \ein \cdots : \tlist{\tint}
    ...
    \inferrule
{
  ...
  {  
    \inferrule
    {
      ...
      {
        \Gamma_8 \tvdash{0} \mathsf{multiRound} : \cdots
      }
      \and
      \inferrule
      {
  ...
  {
    \Gamma_8; [\_ : 0] 
    \tvdash{0} \mathsf{multiRound} \eapp () \eapp \Lambda. \Lambda. \cdots : \tarr{\tint}{\tlist{\tint}}{k - (j + 1)}{[\_: 0]}{k - (j + 1)}
  }
  \and
  \inferrule
  {
