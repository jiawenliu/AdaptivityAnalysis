...
\begin{mathpar}
      \inferrule*[right = fix]
      {
        \inferrule*[right = 2fix]
        {
          \inferrule*[right = if]
          {
            ...
            \nnatA' = \nnatA_0 + \nnatA_1 = 0 + 1 = 1
            \and
            \dmap_2' = \max(\dmap_2' + 0 , \dmap_1') = [j:1, k:1, f:0, db:1]
          }
          {
            \cdot; \Gamma ;  \dmap_2'= [j:1, k:1, f:0, db : 1] 
        ...
        }
        {
          ...
          : \cdots \tarr{\tdb}{\tlist{\treal * \tint}}{1}{[j:1, k:1, f:0]}{1}
        }
      }
      {
        \tvdash{0} \efix \eapp  f(j). \cdots 
    ...
    \inferrule
      ...
      \nnatA' = \max(\nnatA_2, \nnatA_1 + 0) = 1
      \and
      \dmap_2' = \max(\dmap_3' + 1, \dmap_2') = [f: 0, j : 1, k : 1, db :1]
    }
    {
...
\inferrule*[right = app]
{
   \inferrule*[right = app]
    ...
    {
      \cdot; \Gamma'; \dmap_5' = [f: 0, a: 1, j : 1, k : 1] 
