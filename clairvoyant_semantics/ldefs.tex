...
\newcommand{\emonadic}[1]{\{#1\}}


%more expressions
\newcommand{\esign}{\mathop{\kw{sign}}}
\newcommand{\efoldl}{\mathop{\kw{foldl}}}
\newcommand{\elg}{\mathop{\kw{lg}}}
...
\newcommand{\term}{t}
\newcommand{\mexpr}{m}
\newcommand{\mreturn}{\kw{return} \,}
\newcommand{\mlet}[3]{\mathop{\kw{mlet}}\, #1=#2\, \mathop{\kw{in}}\,
#3}
\newcommand{\mpair}[2]{( #1, #2 )_m}
\newcommand{\adapt}{p}
...
\newcommand{\bigstepf}[1]{\mathrel{\Downarrow_f^{#1}}}
