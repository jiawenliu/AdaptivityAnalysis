...
three benchmark sets, including thensorflow, sklearn and pytorch and \todo{research paper~\cite{Jamieson2015TheAO}}.
...
benchmarks,
and \todo{4 programs implementing the strategies from~\cite{Jamieson2015TheAO}}.
...
\todo{Implementing~\cite{Jamieson2015TheAO}.}
