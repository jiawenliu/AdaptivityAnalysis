...
{the walk  that visits each vertex $v$ of the semantics-based dependency graph no more than the value that the weight $w_v$ assign to $\tau$, and visits the maximal number of query nodes. }
...
% longest 
{walk which respect the weights and which visit the maximal query nodes.}
%  as possible. 
