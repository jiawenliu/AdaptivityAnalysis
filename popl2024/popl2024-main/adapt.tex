...
\end{defn} 
\highlight{
In Fig.~\ref{fig:overview-example}(b), with the assumption that $k \geq 1$, $\lambda \trace_0 \st (l^6 \to \underbrace{a^4 \to \ldots}_{\env(\trace) k} \to x^3)$ is a walk where vertex $a^4$ is visited $\env(\trace) k$ times.
