...
\begin{figure}
\begin{mathpar}
  \wq{ \inferrule{ }{\env, x \bigstep \env_1(x),   (x, \env) }  }
  %
  \and
  %
 ...
 \inferrule{ \env, \expr_1 \bigstep \econst, \tr_1 \\ \env, \expr_2 \bigstep \econst, \tr_2  }{\env, \uniform \eapp \expr_1 \eapp
  ...
  \inferrule{
    ...
    \mapsto (\valr_2,   \tr_2  ) ], \expr \bigstep \valr, \tr
  }{
...
\inferrule{
  \env, \expr_1 \bigstep \valr_1, \tr_1 \\
  \env[x \mapsto (\valr_1, \tr_1  )] , \expr_2 \bigstep \valr, \tr_2
}
{\env, \elet x = \expr_1 \ein \expr_2 \bigstep \valr, \trlet (x,
  \tr_1, \tr_2) }
%
\\\\
%
